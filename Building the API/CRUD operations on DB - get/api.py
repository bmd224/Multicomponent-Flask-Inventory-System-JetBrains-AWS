...
def device(identifier):
    if request.method == 'GET':
        ...
        if identifier not in dal:
            return jsonify({'message': 'Device not found'}), 404

        dal[identifier].update(args)
